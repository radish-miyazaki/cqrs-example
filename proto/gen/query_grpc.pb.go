...
func (c *productQueryClient) List(ctx context.Context, in *ProductParam, opts ...grpc.CallOption) (*ProductsResult, error) {
...
func (UnimplementedProductQueryServer) List(context.Context, *ProductParam) (*ProductsResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
...
func _ProductQuery_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductQueryServer).List(ctx, req.(*ProductParam))
	}
	return interceptor(ctx, in, info, handler)
}
